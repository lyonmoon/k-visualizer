...
if( window.location.href.includes("wikipedia.org")  ){
	...
	for(i = 0; i < wordsSubTitle.length; i++){
	    ...
	    for (var j =  0; j < current.length; j++) {
	       ...
	       wordSortTable[current2] = wordSortTable[current2] == undefined ? 20 : wordSortTable[current2]+20;
	    }   
	}
	...
	for(i = 0; i < wordsBold.length; i++){
	    var current = wordsBold[i].toLowerCase();
	    wordSortTable[current] = wordSortTable[current] == undefined ? 15 : wordSortTable[current]+15;
	}
	...
	alert("Please do it in wikipedia.com");
