...
if( window.location.href.includes("wikipedia.org")  ){
	...
	for(i = 0; i < wordsTitle.length; i++){
	    ...
	    wordSortTable[current] = wordSortTable[current] == undefined ? 0 : wordSortTable[current]+0;
	}
	...
	for(i = 0; i < wordsSubTitle.length; i++){
	    ...
	    for (var j =  0; j < current.length; j++) {
	       ...
	       wordSortTable[current2] = wordSortTable[current2] == undefined ? 0 : wordSortTable[current2]+0;
	    }   
	}
